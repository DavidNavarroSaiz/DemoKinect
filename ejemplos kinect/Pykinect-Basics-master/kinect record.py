...
# set the path to where you want the files to be stored
writerC = cv2.VideoWriter(r'C:\Users\dcnav\Desktop\Desktop\kinect\demo_kinectV2\demo_proyecto\Pykinect-Basics-master\prueba8.mp4', cv2.VideoWriter_fourcc(*'XVID'),25, (1920, 1080))
